...
- Выполняет bash-скрипт, соответствующий имени проекта;
...
curl -X POST http://localhost:8080/ \
  ...
  -d '{"object_kind":"pipeline","object_attributes":{"status":"success"},"project":{"path":"project-example"}}'
```

✅ Ожидается:
- Запуск `scripts/project-example.sh`
- Лог в консоли
